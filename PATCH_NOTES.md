...
- Added an opt-in Queue Relay beta that lets a permitted lobby member ask the leader's Account Switcher to start matchmaking without sending a League chat message.
