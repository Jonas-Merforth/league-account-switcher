...
- Restored delayed in-game friend scores for League patch 16.18 Ranked Solo, Flex, Normal Draft, and ARAM Mayhem matches.
- Invalid spectator tower data is now rejected instead of showing misleading totals.
...
- Restored delayed in-game friend scores for League patch 16.15 Ranked Solo, Flex, Normal Draft, and ARAM Mayhem matches.
...
- Fixed Friends sessions and account switching for Riot's new saved-login format, including safely retaining rotated sessions after each Friends refresh.
- Fixed Friends repair and client status incorrectly treating old League or Riot Client lockfiles as running clients.
...
- Added an optional delayed game-score hover for in-game friends, showing their KDA, CS, level, both teams’ kills, towers, objectives, snapshot age, and estimated live game time.
